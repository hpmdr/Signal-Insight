...
fun RsrpExplainer(currentRsrp: Int, onClose: () -> Unit) {
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Column {
                Text(
                    stringResource(R.string.metric_rsrp_label),
                    style = MaterialTheme.typography.headlineSmall,
                    fontWeight = FontWeight.Black,
                    color = MaterialTheme.colorScheme.primary
                )
                Text(
                    stringResource(R.string.metric_rsrp_full),
        ...
        Surface(
            ...
            Row(Modifier.padding(12.dp), verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    stringResource(R.string.metric_rsrp_tip),
...
private fun RsrpFactors() {
    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
        Row {
            ...
            Text(
                stringResource(R.string.rsrp_factor_distance),
                style = MaterialTheme.typography.bodySmall,
                lineHeight = 18.sp
            )
        }
        Row {
            ...
            Spacer(Modifier.width(6.dp))
            Text(
                stringResource(R.string.rsrp_factor_obstacle),
                style = MaterialTheme.typography.bodySmall,
                lineHeight = 18.sp
            )
        }
        Row {
            ...
            Spacer(Modifier.width(6.dp))
            Text(
                stringResource(R.string.rsrp_factor_weather),
                style = MaterialTheme.typography.bodySmall,
                lineHeight = 18.sp
            )
        }
        Row {
            ...
            Spacer(Modifier.width(6.dp))
            Text(
                stringResource(R.string.rsrp_factor_load),
                style = MaterialTheme.typography.bodySmall,
                lineHeight = 18.sp
            )
        }
...
private fun RsrpAssessment(currentRsrp: Int) {
    ...
    when {
        currentRsrp > -85 -> {
            ...
            hintResId = R.string.rsrp_assessment_excellent
        }
        currentRsrp > -95 -> {
            backgroundColor = MaterialTheme.colorScheme.primaryContainer.copy(alpha = 0.6f)
            hintResId = R.string.rsrp_assessment_good
        }
        currentRsrp > -105 -> {
            backgroundColor = MaterialTheme.colorScheme.tertiaryContainer
            hintResId = R.string.rsrp_assessment_fair
        }
        currentRsrp > -115 -> {
            backgroundColor = MaterialTheme.colorScheme.errorContainer
            hintResId = R.string.rsrp_assessment_poor
        }
        else -> {
            backgroundColor = MaterialTheme.colorScheme.errorContainer
            hintResId = R.string.rsrp_assessment_weak
        }
    }
